...
include('include/DB.php'); 
			...
			if(isset($_POST['submit'])) {
				...
				$query=mysqli_query($bd, "insert into contactus(Name,Email,Subject,Message) values ('$name','$email','$subject','$message')");
				if($query) {
    ...
    <div class="container-fluid">
		...
		<div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
            <ul class="navbar-nav">
				...
				<li class="nav-item">
					<a href="contact-us.php" class="nav-link active-nav hover-underline-animation" style="color:white"><i class="fa fa-address-book"style="color:white"></i> Contact</a>
          </li>
        ...
        <div class="row">
			<div class="col-md-8 col-lg-8">
				<div class="title-single-box">
					<h1 class="title-single text-primary">Contact US</h1>
		...
		<div class="card-body">
			<form action="#" role="form" name="edit" method="post">
				<div class="col-lg-12">
					...
					<b><small class="text-muted"><b>Subject</b></small></b>
						<div class="row">
							<div class="form-group col-md-12">
