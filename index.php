...
if($_SESSION['login']!=''){    
	...
	//Login in to the system
		if(isset($_POST['submit'])) {
			$ret=mysqli_query($bd, "SELECT * FROM users WHERE username='".$_POST['username']."' and password='".md5($_POST['password'])."'");
				$num=mysqli_fetch_array($ret);
					if($num>0) {	
						$extra="newsfeed.php"; 					//Redirected location
							$_SESSION['login']=$_POST['username'];  //Session login
